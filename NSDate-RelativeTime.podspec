#
#  Be sure to run `pod spec lint NSDate-RelativeTime.podspec' to ensure this is a
...
#The tests are in `NSDate+RelativeTimeTests.m` and require Kiwi to run.
  ...
  # s.authors      = { "Bart van Zon" => "bartvanzon@gmail.com", "other author" => "email@address.com" }
  # s.author       = 'Bart van Zon', 'other author'
  ...
  s.source       = { :git => "git@github.com:bartj3/NSDate-RelativeTime.git", :tag => "0.0.1" }
